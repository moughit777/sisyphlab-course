...
export default function LessonSidebar({ modules, currentLessonId, onSelectLesson, completedLessons = [] }: Props) {
  ...
  return (
    <div className="h-full flex flex-col border-r border-white/8" style={{ background: 'rgba(5,8,20,0.82)', backdropFilter: 'blur(28px)', fontFamily: 'var(--font-ibm), "IBM Plex Sans Arabic", sans-serif' }}>
      {/* Header */}
