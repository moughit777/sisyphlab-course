  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        style={{ background: 'linear-gradient(135deg, #25D366 0%, #128C7E 100%)', boxShadow: '0 4px 24px rgba(37,211,102,0.5)' }}
        animate={{ y: [0, -6, 0] }}
        transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
        whileHover={{ scale: 1.15, boxShadow: '0 8px 36px rgba(37,211,102,0.7)' }}
        whileTap={{ scale: 0.93 }}
      >
